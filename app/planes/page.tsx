        ...
        <div className="plans-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24, alignItems: "start" }}>
          ...
          <div className="plan-card highlight" style={{ marginTop: -12 }}>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "rgba(79,247,168,.12)", color: "#4ff7a8", border: "1px solid rgba(79,247,168,.25)", borderRadius: 100, fontSize: 12, fontWeight: 700, padding: "4px 12px" }}>
                🎉 Ahorrás {AHORRO_ANUAL}% vs mensual
              </div>
            </div>
            <ul style={{ listStyle: "none", marginBottom: 28, flex: 1 }}>
              {["12 meses de acceso","Cursos ilimitados","Docentes ilimitados","Generación automática","Exportación PDF y Excel","Soporte prioritario","Actualizaciones incluidas"].map((f, i) => (
                <li key={i} className="feat-item"><span style={{ color: "#4ff7a8", fontWeight: 700, flexShrink: 0 }}>✓</span>{f}</li>
              ))}
            </ul>
            <a href="mailto:puntualhorarios@gmail.com?subject=Quiero contratar el plan anual" className="btn-primary" style={{ textDecoration: "none", textAlign: "center", display: "block" }}>
          ...
          <div className="plan-card">
            ...
            <ul style={{ listStyle: "none", marginBottom: 28, flex: 1 }}>
              {["Acceso mes a mes","Cursos ilimitados","Docentes ilimitados","Generación automática","Exportación PDF y Excel","Soporte prioritario"].map((f, i) => (
                <li key={i} className="feat-item"><span style={{ color: "#4ff7a8", fontWeight: 700, flexShrink: 0 }}>✓</span>{f}</li>
              ))}
            </ul>
            <a href="mailto:puntualhorarios@gmail.com?subject=Quiero contratar el plan mensual" className="btn-outline" style={{ textDecoration: "none", textAlign: "center", display: "block" }}>
