...
const PLANS = [
  ...
  {
    name: "Plan Estándar", price: "$199", period: "/ mes · $299 por 2 meses",
    ...
    cta: "Contratar plan estándar →", highlight: true, badge: "🎉 2 meses por $299",
  },
  {
    name: "Plan Completo", price: "$299", period: "/ mes · $400 por 2 meses",
...
export default function PuntualLanding() {
  ...
  const FOOTER_LINKS = {
    ...
    "Términos": "/terminos",
    "Contacto": "mailto:puntualhorarios@gmail.com",
  };
              ...
              <FadeIn key={i} delay={i * 100}>
                <div className={`plan-card ${p.highlight ? "highlight" : ""}`}>
                  ...
                  <button
                    ...
                    onClick={() => router.push(i === 0 ? "/login?tab=registro" : "/planes")}
                  >{p.cta}</button>
                </div>
              </FadeIn>
            ))}
          ...
          <div style={{ display: "flex", gap: 24 }}>
            {Object.entries(FOOTER_LINKS).map(([label, href]) => (
              <a
                key={label}
                href={href}
                style={{ fontSize: 13, color: "#4a5578", cursor: "pointer", textDecoration: "none", transition: "color .2s" }}
